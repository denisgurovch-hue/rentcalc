...
const posts = [
    {
        slug: 'npv-dlya-arendy',
        title: 'NPV для аренды: как понять, выгодна ли квартира на самом деле',
        excerpt: 'Что такое NPV простыми словами, как считать чистую приведённую стоимость для аренды недвижимости и интерпретировать результат. Формула и примеры.',
        tags: ['NPV', 'инвестиции', 'расчёты'],
        date: '2025-11-28',
        dateFormatted: '28 ноября 2025'
    },
    {
        slug: 'samozanyatost-dlya-arendy',
        title: 'Самозанятость для сдачи квартиры',
        excerpt: 'Как легально сдавать квартиру через режим НПД, платить налог 4-6% и не заморачиваться с декларациями. Регистрация, бонус 10 000 ₽ и оформление платежей.',
        tags: ['самозанятость', 'налоги', 'НПД'],
        date: '2025-12-20',
        dateFormatted: '20 декабря 2025',
        image: 'samozanyatost-dlya-arendy.png'
    },
    {
